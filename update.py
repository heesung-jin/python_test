...
<form action="process_update.py" method="post">
	<input type=hidden name=pageId value={update_title}>
	<p><input type="text" name="title" placeholder="title" value={update_title}><p/>
	<p><textarea row="5" name="description" placeholder="description">{update_description}</textarea></p>
	<p><input type="submit" ></p>
</form>
</body>
</html>'''.format(title=pageId, desc=description, listStr=view_list.getList(), update_title=pageId, update_description=description ))
